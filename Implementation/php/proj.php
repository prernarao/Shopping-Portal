...
<div class="heading">
  <br>
	<a class="active" href="proj.php" style="text-decoration:none;"><h1><center><img src="images/fontname.png" style="margin-top:25px;"></h1></a></center>
</div>
<center>
<div class="some">
  <img src="images/wp2.jpg" style="max-width:95%;">
</div></center>
...
<a href="men.php"><img class="mySlides" src="images/p1.jpg" style="width:100%; height:100%;"></a>
...
<section class="w3-row-padding">
  <span class="w3-half">
    ...
    <a href="men.php"><img src="images/botguy.jpg" alt="Random Name" style="width:50%"></a>
  ...
  <span class="w3-half">
    ...
    <a href="women.php"><img src="images/botgirl.jpg" alt="Random Name" style="width:50%"></a>
